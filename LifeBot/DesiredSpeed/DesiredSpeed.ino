...
void Speed(double desiredSpeed)
{
  ...
  while(1)
  {
    ...
    if (t_now - t_last >= T)
    {
        ...
        errorL = desiredSpeed - velocity_L;
        errorR = desiredSpeed - velocity_R;
        ...
        uR = errorR*kPR +  accErrorR*kI + 175;
        uL = errorL*kPL + accErrorL*kI + 175;
